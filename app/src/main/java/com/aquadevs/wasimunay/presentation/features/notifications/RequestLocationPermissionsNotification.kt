...
@Composable
fun RequestLocationPermissionsNotification(notificationViewModel: NotificationViewModel = hiltViewModel()) {
    ...
    Column(
        ...
        when {
            ...
            permissionsState.shouldShowRationale -> {
                MyBody(
                    strBody = R.string.msgPermissionNeedLocation,
            ...
            permissionsState.revokedPermissions.isNotEmpty() -> {
                ...
                MyBody(
                    strBody = R.string.msgPermissionDeneidGoToSettings,
...
private fun MyBody(
    ...
    Column(horizontalAlignment = Alignment.CenterHorizontally) {
        AnimationLottie(
            modifier = Modifier,
            size = 200,
            lottie = R.raw.lottie_location_settings
        )
        TextCustom(
